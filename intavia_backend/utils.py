...
from intavia_backend.query_parameters_v2 import Search as SearchV2, SearchVocabs
...
def get_query_from_triplestore_v2(search: Search, sparql_template: str):
    ...
    """
    if isinstance(search, Search) or isinstance(search, SearchV2) or isinstance(search, SearchVocabs):
